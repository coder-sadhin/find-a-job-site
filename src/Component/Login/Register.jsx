                    ...
                    <form onSubmit={handleSubmit(handleUserRegister)}>
                        {
                            ...
                            <div>
                                ...
                                <div className="text-center mb-10 md:mb-10 lg:mb-[100px] flex gap-4">
                                    ...
                                    <PrimaryButton handler={completeFormStep} disabled={!isValid} type='button' className={`${!isValid ? 'bg-gray-500' : 'bg-theme-primary'} shadow-shadow-tow py-4 px-5 rounded-2xl text-white font-medium flex items-center gap-[10px] mx-auto`}>Next Step <HiArrowNarrowRight /></PrimaryButton>
                                </div>
                                {
                                    formStep === 0 &&
